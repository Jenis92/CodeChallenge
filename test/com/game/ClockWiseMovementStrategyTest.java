...
/**
 * Unit tests for the {@link ClockwiseMovementStrategy} class.
 * These tests verify that the snake moves correctly in a clockwise direction
 * when it encounters the boundaries of a given square.
 */
public class ClockWiseMovementStrategyTest {

    private ClockwiseMovementStrategy strategy;
    private Snake snake;
